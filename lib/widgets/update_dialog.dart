  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: _isDownloading 
        ? UpdateDownloadDialog(downloadedBytes: _downloadedBytes, totalBytes: _totalBytes)
        : _isInstalling
  ...
  Widget _buildInstallingDialog(BuildContext context, bool isDark) {
    return AlertDialog(
      ...
      title: Row(
        children: [
          Container(
            ...
            child: Icon(Icons.install_mobile_rounded, color: Colors.green, size: 28),
          ),
          const SizedBox(width: 12),
          Expanded(
            child: Text('Installing Update', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: isDark ? Colors.white : Colors.black87)),
          ),
        ],
      ),
      content: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text('Opening installer...', style: TextStyle(fontSize: 14, color: isDark ? Colors.white70 : Colors.black54)),
      ]),
    );
  }
      ...
      title: Row(
        children: [
            Container(
              ...
              child: Icon(
                widget.isRequired ? Icons.warning_rounded : Icons.system_update_rounded,
      ...
      actions: [
          TextButton(
            ...
            child: Text(
              ...
              style: TextStyle(
                color: isDark ? Colors.white70 : Colors.black54,
                fontWeight: widget.isRequired ? FontWeight.bold : FontWeight.normal,
              ),
            ),
          ),
          ElevatedButton.icon(
